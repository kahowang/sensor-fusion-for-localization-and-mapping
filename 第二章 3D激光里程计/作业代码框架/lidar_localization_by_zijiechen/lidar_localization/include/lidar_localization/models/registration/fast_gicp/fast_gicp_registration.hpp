...
#include "lidar_localization/models/registration/fast_gicp/fast_gicp_st.hpp"

namespace lidar_localization{

class FASTGICPRegistration : public RegistrationInterface{
public:
    FASTGICPRegistration(const YAML::Node& node);
...
private:
    ...
    fast_gicp::FastGICP<CloudData::POINT, CloudData::POINT> fast_gicp_;
};
