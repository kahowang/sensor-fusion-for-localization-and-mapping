...
public:
  ...
  bool InitOri( Eigen::Matrix4f &init_pose,  CloudData &cloud_data, Eigen::Matrix3f &init_ori );       
...
private:
  ...
  bool InitScanContext(const YAML::Node &config_node);         //  init scancontext for  
